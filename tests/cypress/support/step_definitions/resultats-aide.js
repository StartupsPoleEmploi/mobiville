...
const boutonDecouvrirAide = "main[id=main] * > div > a[href*=aides]";
...
When("je clique sur Découvrir l'aide de la première aide", function () {
    cy.contains(boutonDecouvrirAide, "Découvrir l'aide ", {timeout: SHORT_WAIT_TIME}).first().click();
    cy.wait(1000);
})