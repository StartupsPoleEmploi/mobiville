...
Fonctionnalité: Rechercher villes - filtre des résultats
  ...
  Scénario: Filtre des villes avec peu d'opportunités
    ...
    Alors j'affiche les villes pour lesquelles le critère est "Peu d'opportunités d'emploi"
  ...
  Scénario: Filtre des villes avec des opportunités
    ...
    Alors j'affiche les villes pour lesquelles le critère est "Opportunités d'emploi"