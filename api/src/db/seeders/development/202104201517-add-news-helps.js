module.exports = {
  up: async (queryInterface, Sequelize, models) => {
    ...
    await models.helps.create(
      {
        ...
        who: "salariés, demandeur d'emploi, alternant, moins de 26 ans, plus de 26 ans",
    ...
    await models.helps.create(
      {
        ...
        `,
        cumulable:
          "Cumulable avec la Garantie visale, l'aide mobili-pass et l'avance loca-pass",
    ...
    await models.helps.create(
      {
        ...
        conditions:
          'Les solutions de logement temporaire sont accessibles dans le cadre : d’un premier emploi, d’une formation, d’une mutation professionnelle, d’une mission ponctuelle, d’une alternance, ou d’une situation exceptionnelle.',
        cumulable:
          "Cumulable avec la Garantie visale, l'aide mobili-pass, l'aide mobili jeune et les APL",
    ...
    await models.helps.create(
      {
        ...
        conditions:
          'Jeune de 18 à 30 ans inclus, salarié à partir de 31 ans nouvellement embauché ou en mobilité, ou signataire d’un bail mobilité',
        cumulable: "Oui, notamment avec l'avance loca-pass",
        link: 'https://www.visale.fr/',
        who: "salarié, demandeur d'emploi avec promesse d'embauche, aternance, moins de 26 ans, plus de 26 ans",
        section: 'dossier logement',
        situtation: 'je recherche un logement',
      },
      true
    ...
    await models.helps.create(
      {
        ...
        who: "demandeur d'emploi, moins de 26 ans, plus de 26 ans",
    ...
    await models.helps.create(
      {
        ...
        description:
          "Mise en relation avec un conseiller, afin de proposer un accompagnement sur mesure pour: trouver un logement, réaliser les formalités amdinistratives de départ ou d'arrivée, rechercher des écoles pour les enfants, gestion du déménagement, recherche d'emploi pour le conjoint",
        when: 'Dès connaissance de la mutation ou du projet de mobilité',
        conditions:
          'Vous êtes alternant, intérimaire, salarié d’une entreprise et vous allez vivre une mobilité géographique pour raison professionnelle ?',
        cumulable: 'oui',
        link: 'https://www.manouvelleville.fr/demande-de-contact-salarie/',
        who: 'alternant, salarié, moins de 26 ans, plus de 26 ans',
    ...
    await models.helps.create(
      {
        ...
        description:
          "Les missions des ADIL couvrent notamment : les services au public, le conseil juridique, financier, fiscal mais aussi l'aide au logement des ménages en difficultés, la présentation de l'offre de logements disponibles.",
        when: 'A tout moment',
        conditions: 'Aucune',
        cumulable: 'oui',
        link: 'https://www.anil.org/lanil-et-les-adil/votre-adil/',
        who: "demandeur d'emploi, salarié, alternant, moins de 26 ans, plus de 26 ans",
        section: 'accompagnement, logement',
        situtation: 'je recherche un logement',
      },
      true
    ...
    await models.helps.create(
      {
        ...
        when: 'A tout moment',
        conditions:
          'Les offres Mobilize sont accessibles aux personnes : habitant en France métropolitaine, ayant un besoin de mobilité lié au projet professionnel, majeures et titulaires du permis de conduire, éligibles aux conditions de ressources du programme, éventuellement en situation d’incident bancaire (sur étude du dossier)',
        cumulable: 'oui',
    ...
    await models.helps.create(
      {
        ...
        description:
          'Une plateforme pour demander un logement social, mais aussi  pour consulter et postuler aux logements disponibles directement',
        when: 'A tout moment',
        conditions: 'Etre salarié',
        cumulable: 'oui',
        link: 'https://www.actionlogement.fr/plateforme-locative/salaries',
        who: "salarié, demandeur d'emploi avec promesse d'embauche, alternant, moins de 26 ans, plus de 26 ans",
        section: 'logement',
        situtation: 'je déménage, je recherche un logement',
      },
      true
    ...
    await models.helps.create(
      {
        ...
        conditions:
          'Etre salarié d’une entreprise du secteur privé non agricole de 10 salariés et plus.',
        cumulable: 'oui',
    ...
    await models.helps.create(
      {
        title: 'Alternôme',
        goal: 'Alternôme est la solution de logement sur-mesure pour les étudiants en alternance',
        description:
          'Alternance, stage, césure, internat de médecine, mobilité professionnelle : vous avez besoin d’un logement ? Trouvez un logement libre sur les périodes qui vous intéressent. Vous payez votre part du loyer calculée au prorata du temps occupé dans le logement. Vous économisez sur votre loyer et bénéficiez d’un pied à terre stable tout au long de votre mobilité.	',
        when: 'Dès que vous recherchez un logement',
        conditions: 'Aucune condition',
        cumulable:
          "oui avec la Garantie visale, l'aide Mobili jeune, l'avance loca-pass,	",
