...
import {COLOR_BUTTON_HOVER, COLOR_OTHER_GREEN, COLOR_PRIMARY} from '../../constants/colors'
...
const PaginationContainer = styled.div`
  ...
  nav ul li:first-child button:hover, nav ul li:last-child button:hover {
...
const Cities = () => {
    ...
    const citiesList = (
        <CitiesList isMobile={isMobile} ref={citiesListRef}>
            ...
            <PaginationContainer>
                <Pagination count={noOfPages} defaultPage={0} page={page} siblingCount={2} boundaryCount={0}
