            ...
            <ItemLayout>
              ...
              <ItemContentLayout>
                <ElementObject>
                  ...
                  <p className="details">
                    {cityTenement && cityTenement.nbSocialHousing
                      ? cityTenement.nbSocialHousing
                      : 'A venir'}
                  </p>
                </ElementObject>
                <ElementObject>
          ...
          <div>
            <ItemLayout>
              ...
              <ItemContentLayout>
                ...
                <p>
                  <b>
                    Il y a {city && city.city_house_tension ? 'plus' : 'moins'}{' '}
                    d{"'"}
                ...
                <p>
                  ...
                  {"'"}
                  impact sur le marché immobilier dans les 6 prochains mois
                  grâce au rapport entre le nombre d{"'"}
          ...
          <ItemLayoutMobile>
            ...
            <ItemContentLayout>
              <ElementObject>
                ...
                <p className="details">
                  {city && city.average_houseselled
                    ? `${city.average_houseselled.toFixed(2)}€`
                    : 'A venir'}
                </p>
              </ElementObject>
              <ElementObject>
